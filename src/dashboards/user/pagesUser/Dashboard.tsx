    ...
    return(
        <div className="space-y-4 md:space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
              <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 p-3 md:p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Documents traités</p>
              ...
              <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 p-3 md:p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Documents consommés</p>
              ...
              <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 p-3 md:p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Documents restants</p>
                    <p className="text-lg md:text-2xl font-bold text-gray-900">144</p>
                  </div>
              ...
              <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 p-3 md:p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Précision moyenne</p>
                    <p className="text-lg md:text-2xl font-bold text-gray-900">98.5%</p>
                  </div>
              ...
              <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 p-3 md:p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Temps moyen</p>
                    <p className="text-lg md:text-2xl font-bold text-gray-900">2.3s</p>
                  </div>
                  <div className="w-8 h-8 md:w-12 md:h-12 bg-yellow-100 rounded-lg flex items-center justify-center">
                    <Search className="w-4 h-4 md:w-6 md:h-6 text-yellow-600" />
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 p-3 md:p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-xs md:text-sm font-medium text-gray-600">Documents en attente</p>
                  ...
                  <div className="w-8 h-8 md:w-12 md:h-12 bg-red-100 rounded-lg flex items-center justify-center">
                    <Upload className="w-4 h-4 md:w-6 md:h-6 text-red-600" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg md:rounded-xl shadow-sm border border-gray-200 p-4 md:p-6">
              <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-3 md:mb-4">Activité récente</h3>
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-center space-x-3 md:space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="text-xs md:text-sm font-medium text-gray-900">Document traité avec succès</p>
                ...
                <div className="flex items-center space-x-3 md:space-x-4">
                  <div className="w-6 h-6 md:w-8 md:h-8 bg-green-100 rounded-lg flex items-center justify-center">
                    <Upload className="w-3 h-3 md:w-4 md:h-4 text-green-600" />
                  </div>
                  <div className="flex-1">
                    <p className="text-xs md:text-sm font-medium text-gray-900">Nouveau document uploadé</p>
